...
min_quantile_score = pmin(quantile_mapped_reads,quantile_mapping_rate,quantile_library_complexity)
...
weight_vector = c(weight_mapped_reads,weight_mapping_rate,weight_library_complexity)
#header = c('Weight.MappedReads','Weight.MappingRate','Weight.LibraryComplexity','Weight.GeneDetected')
header = c('Weight.MappedReads','Weight.MappingRate','Weight.LibraryComplexity')
...
names(weight_vector) = c('Weight.MappedReads','Weight.MappingRate','Weight.LibraryComplexity')
...
for(i in 1:length(quantile_mapped_reads)){
  ...
  this_quantile_vector = c(quantile_mapped_reads[i],quantile_mapping_rate[i],quantile_library_complexity[i])
